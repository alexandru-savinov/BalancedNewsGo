...
class ProgressIndicator extends HTMLElement {
  ...
  async connect(articleId) {
    ...
    try {
      ...
      this.#sseClient.addEventListener('error', (data) => {
        ...
        this.#dispatchEvent('connectionerror', data);
      });
  ...
  updateProgress(progressData) {
    ...
    this.#stage = progressData.stage || progressData.step || this.#stage;
  ...
  #updateUI() {
    ...
    this.percentageText.textContent = `${Math.round(this.#progressValue)}%`;
