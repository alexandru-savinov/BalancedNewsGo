...
class ModalTests {
  ...
  async testComponentInitialization() {
    this.totalTests++;
    try {
      // Debug: Check if custom element is defined
      console.log('Custom element defined:', customElements.get('modal-component'));
      
      const modal = document.createElement('modal-component');
      console.log('Modal instance:', modal);
      console.log('Modal constructor:', modal.constructor.name);
      console.log('Modal open method type:', typeof modal.open);
      console.log('Modal setContent method type:', typeof modal.setContent);
...
if (typeof test === 'function') {
  test('Modal component custom tests pass', async () => {
